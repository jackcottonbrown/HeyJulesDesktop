...
describe("DesktopEnvironment", () => {
  it.effect("derives state paths and development identity inside Effect", () =>
    Effect.gen(function* () {
      ...
      assert.equal(environment.appUserModelId, "com.heyjules.desktop.dev");
      assert.equal(environment.linuxWmClass, "heyjules-desktop-dev");
      assert.deepEqual(
  ...
  it.effect("keeps implicit development state separate from production state", () =>
    Effect.gen(function* () {
      ...
      assert.equal(development.stateDir, "/Users/alice/.heyjules-desktop/dev");
      assert.equal(production.stateDir, "/Users/alice/.heyjules-desktop/userdata");
    }),
  );
