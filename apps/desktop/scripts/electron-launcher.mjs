// This file mostly exists because we want dev mode to use the product identity instead of "electron".
...
const devBundleIdSuffix = NodePath.basename(repoRoot)
  .toLowerCase()
  .replaceAll(/[^a-z0-9]+/g, "");
export const APP_DISPLAY_NAME = isDevelopment ? "HeyJules Desktop (Dev)" : "HeyJules Desktop";
export const APP_BUNDLE_ID = isDevelopment
  ? `com.heyjules.desktop.dev.${devBundleIdSuffix || "local"}`
  : "com.heyjules.desktop";
const APP_PROTOCOL_SCHEMES = isDevelopment ? ["heyjules-dev"] : ["heyjules"];
