...
describe("electron development launcher", () => {
  ...
  it("keeps the native Electron executable name inside the branded macOS bundle", () => {
    const paths = resolveMacLauncherPaths(
      "/repo/apps/desktop/.electron-runtime/HeyJules Desktop (Dev).app",
      "HeyJules Desktop (Dev)",
    );

    assert.equal(paths.launcherExecutableName, "HeyJules Desktop (Dev) Launcher");
    assert.equal(
      paths.launcherBinaryPath,
      "/repo/apps/desktop/.electron-runtime/HeyJules Desktop (Dev).app/Contents/MacOS/HeyJules Desktop (Dev) Launcher",
    );
    assert.equal(
      paths.runtimeElectronBinaryPath,
      "/repo/apps/desktop/.electron-runtime/HeyJules Desktop (Dev).app/Contents/MacOS/Electron",
    );
    ...
    assert.include(
      script,
      "exec '/repo/apps/desktop/.electron-runtime/HeyJules Desktop (Dev).app/Contents/MacOS/Electron'",
    );
