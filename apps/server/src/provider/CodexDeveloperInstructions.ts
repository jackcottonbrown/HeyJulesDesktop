...
export function buildCodexDeveloperInstructions(
  ...
  return `${base}${HEY_JULES_AGENT_INSTRUCTIONS}

<runtime_info>In case you're asked: you are running in HeyJules Desktop through the Codex harness, as ${toSingleLine(runtime.model)} with ${toSingleLine(runtime.reasoningEffort)} reasoning effort. No need to mention this otherwise.</runtime_info>`;
}
